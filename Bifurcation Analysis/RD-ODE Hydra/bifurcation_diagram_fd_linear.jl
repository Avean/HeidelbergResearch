...
int_param = [0.5, 4.0]  # interval of continuation for the diffusion coefficient
...
bifurcationdiagram!(prob,
	...
	# has ? branches
	get_branch(diagram, (2,)), 2, opts_br;
	verbosity = 0, plot = true,
	# callback_newton = cb,
	# finalise_solution = finSol,
	usedeflation = true,
