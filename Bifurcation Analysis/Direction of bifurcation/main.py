...
if __name__ == '__main__':
    ...
    [func_f, func_g, func_h], initial_guess_steady_state = models.classical_GM_2_heads()

    length_domain = 1.0 #5.3
    Diff_2 = 0.1 #0.05 #0.05
    ...
    # turing_bif.plot_B_k_for_multiple_domain_sizes(np.linspace(0.1, 3, 100))
